      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        ...
        <div className="flex flex-wrap gap-2 w-full sm:w-auto">
          <button
            ...
            className="flex-1 sm:flex-initial inline-flex items-center justify-center gap-1.5 rounded-lg border border-slate-200 px-3 py-2 text-xs font-semibold text-slate-700 hover:bg-slate-50 disabled:opacity-50 dark:border-[#1a3d8e]/60 dark:text-slate-200 dark:hover:bg-[#091f52] cursor-pointer min-h-[38px]"
          >
            {busy === "refresh" ? (
          ...
          <button
            ...
            disabled={busy !== null}
            className="flex-1 sm:flex-initial inline-flex items-center justify-center gap-1.5 rounded-lg bg-[#1a3d8e] px-3 py-2 text-xs font-semibold text-white hover:bg-[#345ec4] disabled:opacity-50 cursor-pointer shadow-xs min-h-[38px]"
          >
            {busy === "process" ? (
              <Loader2 className="h-3.5 w-3.5 animate-spin" />
            ) : (
          ...
          {currentCase && (
            <>
              <button
                ...
                className="flex-1 sm:flex-initial inline-flex items-center justify-center gap-1.5 rounded-lg border border-amber-200 px-3 py-2 text-xs font-semibold text-amber-800 hover:bg-amber-50 disabled:opacity-50 dark:border-amber-900/60 dark:text-amber-200 dark:hover:bg-amber-950/40 min-h-[38px]"
              >
                {busy === "retry" ? (
                  <Loader2 className="h-3.5 w-3.5 animate-spin" />
                ) : (
              ...
              <button
                ...
                disabled={!backendConnected || busy !== null}
                className="flex-1 sm:flex-initial inline-flex items-center justify-center gap-1.5 rounded-lg border border-rose-200 px-3 py-2 text-xs font-semibold text-rose-700 hover:bg-rose-50 disabled:opacity-50 dark:border-rose-900/60 dark:text-rose-300 dark:hover:bg-rose-950/40 min-h-[38px]"
              >
          ...
          {onExit && (
            <button
              type="button"
              onClick={onExit}
              className="w-full sm:w-auto inline-flex items-center justify-center gap-1.5 rounded-lg border border-slate-300 dark:border-[#1a3d8e] bg-slate-50 dark:bg-[#091f52] px-3 py-2 text-xs font-semibold text-slate-800 dark:text-slate-100 hover:bg-slate-100 dark:hover:bg-[#0c2a72] transition-colors cursor-pointer min-h-[38px]"
            >
