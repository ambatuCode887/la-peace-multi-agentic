      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        ...
        {onExit && (
          <button
            type="button"
            onClick={onExit}
            className="inline-flex shrink-0 items-center gap-1.5 rounded-lg bg-slate-900 px-4 py-2 text-xs font-semibold text-white shadow-sm transition-colors hover:bg-slate-700 dark:border dark:border-[#5a82e2]/40 dark:bg-[#1a3d8e] dark:hover:bg-[#345ec4] cursor-pointer"
          >
